...
export default async function BloqueioPage() {
  ...
  if (!usuario.restauranteId) redirect("/login");
  ...
  if (restaurante?.status_assinatura === "active") {
    redirect("/escalas");
  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0b0d10] px-4 font-sans text-[#f1f0ec]">
      <div className="w-full max-w-md rounded-2xl border border-white/[0.06] bg-white/[0.03] p-8 text-center">
        ...
        <p className="mt-3 text-sm text-white/50">
          Pra continuar gerenciando escalas e a equipe, escolha um plano. Seus
          dados continuam guardados — nada é perdido enquanto a assinatura está
          pausada.
        </p>
